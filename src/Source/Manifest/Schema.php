        ...
        $tree->getRootNode()
            ...
            ->arrayPrototype()
                ...
                ->children()
                    ...
                    ->end()
                    ->scalarNode('context_url')
                        ->isRequired()
                        ->cannotBeEmpty()
                        ->info('JSON-LD context defining the model\'s terms. Without the right one a consumer reads the entity\'s attributes as undefined strings.')
                    ->end()
